                ...
                <div class="col-md-4">
                    <div class="card card-body">
                        <div class="text-center profile-image">
                            <img  height="150px" width="150px" src="@if($user->profileImage){{ asset('images')}}/{{Auth::user()->profileImage }}@else{{asset('frontend/images/avatar3.png')}}@endif" width="75%" class="rounded-circle" alt="">
                        </div>
                    ...
                    <div class="card card-body">                        
                        <form class="form-layout form-layout-1" action="{{route('superUser.upadte')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group my-3">
                                ...
                                <input disabled class="form-control" type="text" name="name" value="{{Auth::user()->name}}" placeholder="{{__('name')}}" required>
                                @error('name')
                            ...
                            <div class="form-group my-3">
                                ...
                                <input disabled class="form-control" type="text" name="email" value="{{Auth::user()->email}}" placeholder="{{__('email')}}" required>
                                @error('email')
                                    <span class="invalid-feedback d-block" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input disabled  class="form-control" type="text" name="Country" value="{{Auth::user()->country}}" placeholder="{{__('Country')}}" required>
                                @error('Country')
                                    <span class="invalid-feedback d-block" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input disabled class="form-control" type="text" name="City" value="{{old('City',Auth::user()->Town)}}" placeholder="{{__('city')}}" required>
                                @error('City')
                                    <span class="invalid-feedback d-block" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                           ...
                           <div class="row">
                                <div class="col-md-6">
                                            <div class="form-group mb-2">
                                                ...
                                                <input  class="form-control" type="text" name="phone_1" value="{{old('phone_1',Auth::user()->phone_1)}}" placeholder="{{__('city')}}" required>
                                                @error('phone_1')
                                                    <span class="invalid-feedback d-block" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                ...
                                <div class="col-md-6">
                               <div class="form-group mb-2">
                                <label class="form-control-label">Phone 2: <span class="text-danger">*</span></label>
                                <input class="form-control" type="text" name="phone_2" value="{{old('phone_2',Auth::user()->phone_2)}}" placeholder="{{__('city')}}" required>
                                @error('phone_2')
                                    <span class="invalid-feedback d-block" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
